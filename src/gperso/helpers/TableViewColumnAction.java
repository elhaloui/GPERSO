...
public class TableViewColumnAction implements MessageSourceAware {
    ...
    public Node getSingleHyperlinkTableModel(String textOfLink) {
        ...
        this.deleteLink.setText(textOfLink);
        return deleteLink;
    }
